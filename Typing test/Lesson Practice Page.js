...
if (!lesson) {
    ...
    document.body.innerHTML = `
        ...
        <div class="practice-layout">
            <aside class="practice-sidebar" aria-label="Lesson navigation">
                <div class="sidebar-heading"><span>lesson</span></div>
                <nav class="paragraph-nav" aria-label="Lesson navigation">
                    <a class="paragraph-link active" href="Learn While Typing.html"><span class="paragraph-index">${subject}</span><span class="paragraph-name">${title}</span></a>
                    <a class="paragraph-link" href="Learn While Typing.html"><span class="paragraph-index">←</span><span class="paragraph-name">All lessons</span></a>
                </nav>
            </aside>
            <main>
                <section>
